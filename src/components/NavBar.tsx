...
const NavBar = () => {
    ...
    return (
        <nav className='nav__container sticky top-0 h-auto min-h-[70px] z-50 bg-[rgb(20,20,20)] text-[#e5e5e5]'>
                ...
                <div className='flex absolute top-0 right-[4%] h-full justify-end items-center grow'>
                    <div className='mr-[8px]'>
                        <div
                            ...
                            className={`flex items-center ${isSearchActive
                        ...
                        >
                            ...
                            <input
                                ...
                                className={`bg-transparent border-none outline-none text-[14px] text-white ml-2 ${isSearchActive
                            ...
                            {isSearchActive && (
                                <span
                                    role="button"
                                    className={`cursor-pointer text-white ml-2 transition-opacity ${searchText ? "opacity-100" : "opacity-0 cursor-default"
                                        }`}
                    ...
                    <div className='flex items-center group'>
                        <a className='cursor-pointer'>
                            <span>
                                <img className='rounded-[4px] w-[32px] h-[32px] align-middle' src='https://i.ibb.co/PFwZcX0/profile-1.png'></img>
                            </span>
                        </a>
