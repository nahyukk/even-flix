    ...
    return (
        <footer className="text-[#808080] mt-[20px] mx-auto max-w-[980px] px-[4%] bg-[#141414] leading-[1.4]">
            ...
            <div className="text-[11px] text-[#808080] mb-[15px]">
                ...
                <div className="mt-[4px]"><a className="hover:underline" href="/#">공정거래위원회 웹사이트</a></div>
            </div>
        </footer>
    );
};
